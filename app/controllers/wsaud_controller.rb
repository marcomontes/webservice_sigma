class WsaudController < ApplicationController
  ...
  def recibir_datos_audiencia_publica
    ...
    soap_body = VitalAdapter.soap_body('wsaud', 'recibir_datos_audiencia_publica') 
  ...
  def respuesta_inscripcion_audiencia
    response = create_response
    soap_body = VitalAdapter.soap_body('wsaud', 'respuesta_inscripcion_audiencia')
  ...
  def aprueba_inscripcion_audiencia
    response = create_response
    soap_body = VitalAdapter.soap_body('wsaud', 'aprueba_inscripcion_audiencia')
  ...
  def datos_inscripcion_audiencia
    response = create_response
    soap_body = VitalAdapter.soap_body('wsaud', 'datos_inscripcion_audiencia')
  ...
  def inscripcion_audiencia_aa
    response = create_response
    soap_body = VitalAdapter.soap_body('wsaud', 'inscripcion_audiencia_aa')
